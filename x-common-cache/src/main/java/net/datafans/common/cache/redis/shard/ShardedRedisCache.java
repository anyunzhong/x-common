...
public class ShardedRedisCache {
	...
	private static final Logger log = LoggerFactory.getLogger(ShardedRedisCache.class);

	private ShardedRedisDataSource redisDataSource;
	...
	public ShardedRedisCache(int maxActive, int maxIdle, int maxWait, List<JedisShardInfo> shards) {
		...
		redisDataSource = new ShardedRedisDataSource();
